...
export const addCategory = (name, description, status) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4001/category/addcategory';
...
export const getCategory = () => {
    return (dispatch) => {
      ...
      const url = 'http://localhost:4001/category/';
...
export const updateCategory = (category_id, { name, description, status }) => {
    return (dispatch) => {
      ...
      const url = `http://localhost:4001/category/${category_id}`;
  ...
  export const deleteCategory = (category_id) => {
    return (dispatch) => {
      ...
      axios
        .put(`http://localhost:4001/category/changestatus/${category_id}`)
        .then((response) => {
          dispatch({

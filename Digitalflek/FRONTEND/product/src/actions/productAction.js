...
export const addProduct = (name, pack_size, category_id, mrp, image, status) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:4001/product/addproduct';
...
export const updateProduct = (product_id, { name, pack_size, category_id, mrp, image, status }) => {
    return (dispatch) => {
      ...
      const url = `http://localhost:4001/product/updateproduct/${product_id}`;
  ...
  export const deleteProduct = (product_id) => {
    return (dispatch) => {
      ...
      axios
        .put(`http://localhost:4001/product/changestatus/${product_id}`)
        .then((response) => {
          dispatch({
